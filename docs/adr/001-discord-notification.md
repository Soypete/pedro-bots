...
## Context
The original TweetWatch implementation delivered curated tweet digests via Twilio/WhatsApp. We need to switch to Discord for the following reasons:
...
- **Negative**: Requires migration of existing Twilio credentials
